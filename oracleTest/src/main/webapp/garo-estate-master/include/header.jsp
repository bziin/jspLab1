                    ...
                    <div class="col-md-5 col-sm-8  col-xs-12">
                        <div class="header-half header-call">
                            <p>
                                ...
                                <span><i class="pe-7s-mail"></i> 홍길동@naver.com</span>
                            </p>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    <div class="button navbar-right">
                        ...
                        <button class="navbar-btn nav-button wow fadeInRight" onclick=" window.open('submit-property.html')" data-wow-delay="0.48s">게시물 등록</button>
                    </div>
                    <ul class="main-nav nav navbar-nav navbar-right">
                        ...
                        <li class="wow fadeInDown" data-wow-delay="0.2s"><a class="" href="properties.html">게시판</a></li>
